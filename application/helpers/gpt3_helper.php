...
if (!function_exists('gpt_utf8_encode')){
...
if (!function_exists('gpt_encode')){
    function gpt_encode($text) 
    {
        ...
        $raw_chars = file_get_contents("vendor/gpt3/characters.json");
        ...
        $rencoder = file_get_contents("vendor/gpt3/encoder.json");
        ...
        $bpe_file = file_get_contents("vendor/gpt3/vocab.bpe");
        if(empty($bpe_file))
        {
...
if (!function_exists('gpt_my_filter')){
...
if (!function_exists('gpt_dictZip')){
...
if (!function_exists('gpt_get_pairs')){
...
if (!function_exists('gpt_indexOf')){
